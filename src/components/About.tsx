...
const About = () => {
    return (
        <section className="h-screen flex flex-col items-center" id="about" >
            ...
            <Link className='border border-solid border-black rounded-full animate-bounce border-whiteCustom' href="#experience" ><Image src="/assets/arrow.png" alt='arrow to bottom' width="28" height="28" className="" /></Link>
        </section>
    )
}
